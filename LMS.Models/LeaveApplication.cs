...
namespace LMS.Models
{
	...
	public partial class LeaveApplication : ISpecificRecord
	{
		public static Schema _SCHEMA = Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"LeaveApplication\",\"namespace\":\"LMS.Models\",\"fields\":[{\"n" +
				"ame\":\"EmpEmail\",\"type\":\"string\"},{\"name\":\"EmpDepartment\",\"type\":\"string\"},{\"name" +
				"\":\"LeaveDurationInHours\",\"type\":\"int\"},{\"name\":\"LeaveStartDateTicks\",\"type\":\"lon" +
				"g\"}]}");
		...
		public virtual Schema Schema
		{
			get
			{
				return LeaveApplication._SCHEMA;
			}
		}
