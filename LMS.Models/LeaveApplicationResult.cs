...
namespace LMS.Models
{
	...
	public partial class LeaveApplicationResult : ISpecificRecord
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""LeaveApplicationResult"",""namespace"":""LMS.Models"",""fields"":[{""name"":""EmpEmail"",""type"":""string""},{""name"":""EmpDepartment"",""type"":""string""},{""name"":""LeaveDurationInHours"",""type"":""int""},{""name"":""LeaveStartDateTicks"",""type"":""long""},{""name"":""ProcessedBy"",""type"":""string""},{""name"":""Result"",""type"":""string""}]}");
		...
		public virtual Schema Schema
		{
			get
			{
				return LeaveApplicationResult._SCHEMA;
			}
		}
